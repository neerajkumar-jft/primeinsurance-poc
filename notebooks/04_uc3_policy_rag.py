...
# MAGIC %md
# MAGIC # RAG Policy Assistant — UC3
# MAGIC Converts dim_policy rows into natural language documents, embeds with sentence-transformers, builds FAISS index, answers questions with cited policy numbers.
...
SYSTEM_PROMPT = """You are a policy intelligence assistant at PrimeInsurance. Claims adjusters ask you questions about insurance policies. You answer based ONLY on the policy documents
provided below.
