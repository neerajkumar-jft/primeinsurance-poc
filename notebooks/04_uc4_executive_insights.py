...
Focus on what an executive needs to decide or act on TODAY."""
    ...
    for attempt in range(3):
        try:
            ...
            # databricks-gpt-oss-20b returns list of dicts, extract text
    ...
    return {
        "headline": f"KPI summary for {domain_info['title']}",
        "key_findings": ["See KPI data snapshot for details"],
        "alerts": [],
        "recommendations": ["Review raw KPI data for actionable insights"],
        "estimated_impact": "Refer to metrics",
    }
